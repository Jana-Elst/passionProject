...
pubDate: 'Jan 6 2026'
heroImage: '../../assets/pictures/20260106-header.webp'
sources:
...
import resistanceVideo from '../../assets/videos/20260106-resistance.mp4?url';
import ringVideo from '../../assets/videos/20260106-ring.mp4?url';

## Creating an intercom
Today I will create an intercom. By building this intercom, I can check if the old rotary phones are still working. In my [last post](../20260105-hardware), I mentioned that these phones were originally powered by 48V DC, but I found out they can actually run on a much safer 9V battery. By creating a simple circuit with two phones and a 9V battery, you basically get an intercom.
...
Next, I wanted to see if I could make the other phone ring as well. But suddenly, sparks started flying from the connection between the two wires...

### An old paper-in-oil capacitor...
All the components of an old phone are very robust and can stand the test of time, except one: the paper-in-oil capacitor. It's the core of the phone's electrical circuit, and over time, it had become a conductor. So, what happened was that I connected the + directly to the -, creating a short circuit. Luckily, nothing was broken, and after I changed the old capacitor to a new one (WIMA MKPA10 I 1µF 630VDC 400VAC), the phone started ringing!
...
![IMAGE](../../assets/pictures/20260106-old-capacitor.webp)

![IMAGE](../../assets/pictures/20260106-new-capacitor.webp)
