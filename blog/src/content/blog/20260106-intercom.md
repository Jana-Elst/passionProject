...
I saw a video of someone building a similar setup, and they started by measuring the resistance of the phones. I grabbed my multimeter and did the same. Here is what I found:
...
All the components of an old phone are very robust and kunnen de tijd overleven, but one component doesn't: the paper-in-oil capacitor. It's the core of the phone's electrical circuit, and over time it just became a conductor. So what I did was connecting the + directly to the - of my circuit and i created a short circuit. Luckly, nothing was broken and after I changed the old capacitor to a new one (MODELNAAM), the phone started ringing!