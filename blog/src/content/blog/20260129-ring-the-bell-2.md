...
pubDate: 'Jan 29 2026'
heroImage: ../../assets/pictures/20260129-header.webp
sources:
...
Before introducing DC power back into the mix, I tested the AC circuit in isolation. The bells rang perfectly! I used a multimeter to check the relay outputs again (which toggle the DC voltage) to ensure no current was leaking where it shouldn't.
...
During my initial tests, I used a simple 9V battery. However, once I switched to a 12V DC power supply and a buck converter, a significant amount of background noise appeared. The interference seemed to originate from the transformer and was amplified by the buck converter's switching frequency. I managed to make it quieter by adding a capacitor to filter out the interference.
